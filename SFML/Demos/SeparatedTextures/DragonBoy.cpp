...
bool loadTextures(dragonBones::DragonBonesData* dragonBonesData, dragonBones::SFMLFactory* factory, const std::string& folder)
{
	...
	if (factory->createTextureAtlasData(texturesData, dragonBonesData) == nullptr)
		return false;
...
int main()
{
	...
	if (!loadTextures(dragonBonesData, &factory, "DragonBoy_texture"))
		return 0;
