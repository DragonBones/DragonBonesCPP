...
class AnimationTimelineState final : public TimelineState 
{
...
protected:
    ...
    void _onCrossFrame(FrameData* frame) override;

public:
    void update(int time) override;
};

class BoneTimelineState final : public TweenTimelineState
{
...
class SlotTimelineState final : public TweenTimelineState
{
...
class FFDTimelineState final : public TweenTimelineState
{
