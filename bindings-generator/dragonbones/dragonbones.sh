...
_CONTENTS=""
_CONTENTS+="[DEFAULT]"'\n'
_CONTENTS+="cocosdir=$CXX_GENERATOR_ROOT/../../cocos2d-x/cocos2d-x"'\n'
...
# Generate bindings for dragonbones
echo "Generating bindings for dragonbones..."
set -x
LD_LIBRARY_PATH=${CXX_GENERATOR_ROOT}/libclang $PYTHON_BIN ${CXX_GENERATOR_ROOT}/generator.py ${CXX_GENERATOR_ROOT}/dragonbones/dragonbones.ini -t spidermonkey -s dragonbones -o ../../external/dragonbones/bindings

#修改关键字参数名 删除多余的逗号 
perl -0pe "s/function\s*\([^)]+/function (/g" ../../external/dragonbones/bindings/api/dragonbones_bindings_api.js | perl -0pe "s/,(\s*\})/\1/g" | perl -0pe "s/return \S+/return this;/g" > ../../js/html5_stub/dragonbones_bindings_api.js
